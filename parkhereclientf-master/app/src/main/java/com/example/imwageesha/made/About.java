    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        int id = item.getItemId();
         ...
         if (id == R.id.nav_gallery) {
            ...
            Intent show = new Intent(this, History.class);
            startActivity(show);
        }  else if (id == R.id.nav_send) {
            Intent show = new Intent(this, MyPoints.class);
            startActivity(show);
        } else if (id == R.id.nav_send1) {
            Intent show = new Intent(this, Help.class);
            startActivity(show);
        } else if (id == R.id.nav_send2) {
            Intent show = new Intent(this, About.class);
            startActivity(show);
